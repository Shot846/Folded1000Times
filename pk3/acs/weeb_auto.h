script WEEB_ENTER ENTER
{
    ...
    // You may now applaud his genius.
        ...
        if (CheckInventory("GhostStepCooldown") == 0 && CheckInventory("GhostStepDone") == 0)
        {
          ...
          {
              if (CheckInventory("OnTheGround") == 1) { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)),35.0),vely + FixedMul(sin(GetActorAngle(0)),35.0),-21.0,1,0); } else { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)),35.0),vely + FixedMul(sin(GetActorAngle(0)),35.0),5.0,1,0); }
              ActivatorSound("ghost/step",127);
              GiveInventory("GhostStepDone",1);
              GiveInventory("GhostStepCooldown",35);
              ACS_ExecuteAlways(WEEB_DECORATE,0,6,0,0);
          ...
          {
              if (CheckInventory("OnTheGround") == 1) { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)+16384),35.0),vely + FixedMul(sin(GetActorAngle(0)+16384),35.0),-21.0,1,0); } else { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)+16384),35.0),vely + FixedMul(sin(GetActorAngle(0)+16384),35.0),5.0,1,0); }
              ActivatorSound("ghost/step",127);
              GiveInventory("GhostStepDone",1);
              GiveInventory("GhostStepCooldown",35); 
              ACS_ExecuteAlways(WEEB_DECORATE,0,6,0,0);
          ...
          {
              if (CheckInventory("OnTheGround") == 1) { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)+32768),35.0),vely + FixedMul(sin(GetActorAngle(0)+32768),35.0),-21.0,1,0); } else { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)+32768),35.0),vely + FixedMul(sin(GetActorAngle(0)+32768),35.0),5.0,1,0); }
              ActivatorSound("ghost/step",127);
              GiveInventory("GhostStepDone",1);
              GiveInventory("GhostStepCooldown",35); 
              ACS_ExecuteAlways(WEEB_DECORATE,0,6,0,0);
          ...
          {
              if (CheckInventory("OnTheGround") == 1) { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)+49152),35.0),vely + FixedMul(sin(GetActorAngle(0)+49152),35.0),-21.0,1,0); } else { SetActorVelocity(0,velx + FixedMul(cos(GetActorAngle(0)+49152),35.0),vely + FixedMul(sin(GetActorAngle(0)+49152),35.0),5.0,1,0);}
              ActivatorSound("ghost/step",127);
              GiveInventory("GhostStepDone",1);
              GiveInventory("GhostStepCooldown",35); 
              ACS_ExecuteAlways(WEEB_DECORATE,0,6,0,0);
